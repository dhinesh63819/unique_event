...
(function (z) {
  ...
  var ze = /^\[object (?:Uint8|Uint8Clamped|Uint16|Uint32|Int8|Int16|Int32|Float32|Float64)Array]$/,
    ...
    _rb = function rb() {
      if (w(_rb.name_)) return _rb.name_;
      var a,
        b,
        d = Qa.length,
        c,
...
// require("./bootstrap");
__webpack_require__(/*! ./angular-js.js */ "./resources/js/angular-js.js");
...
myApp.controller("MyController", ["$scope", function ($scope) {
  ...
  manup.init = function (price_data) {
    manup.price_details = price_data;
  };

  // Input Ticket Count

  manup.number_of_ticket = function (current_value, ticket_type) {
  ...
  manup.ticket_minus = function (ticket_type) {
    ...
    } else if (ticket_type == "prim_sgl" && manup.prim_sgl_tickets > 0) {
      manup.prim_sgl_tickets -= 1;
    } else if (ticket_type == "prim_cup" && manup.prim_cup_tickets > 0) {
  ...
  manup.ticket_pluse = function (ticket_type) {
    if (ticket_type == "std_sgl") {
      manup.std_sgl_tickets += 1;
    } else if (ticket_type == "std_cup") {
      manup.std_cup_tickets += 1;
  ...
  manup.get_tickets = function () {
    if (manup.std_sgl_tickets > 0 || manup.std_cup_tickets > 0 || manup.prim_sgl_tickets > 0 || manup.prim_cup_tickets > 0 || manup.kids_tickets > 0 || manup.entry_tickets > 0) {
      manup.ticket_booking_uri = "ticket-booking?";
      manup.ticket_booking_params = "";
      if (manup.std_sgl_tickets > 0) {
        manup.ticket_booking_params += "std_sgl=".concat(manup.std_sgl_tickets);
      }
      if (manup.std_cup_tickets > 0) {
        manup.ticket_booking_params += manup.ticket_booking_params == "" ? "std_cup=".concat(manup.std_cup_tickets) : "&std_cup=".concat(manup.std_cup_tickets);
      }
      if (manup.prim_sgl_tickets > 0) {
        manup.ticket_booking_params += manup.ticket_booking_params == "" ? "prim_sgl=".concat(manup.prim_sgl_tickets) : "&prim_sgl=".concat(manup.prim_sgl_tickets);
      }
      if (manup.prim_cup_tickets > 0) {
        manup.ticket_booking_params += manup.ticket_booking_params == "" ? "prim_cup=".concat(manup.prim_cup_tickets) : "&prim_cup=".concat(manup.prim_cup_tickets);
      }
      if (manup.kids_tickets > 0) {
        manup.ticket_booking_params += manup.ticket_booking_params == "" ? "kids=".concat(manup.kids_tickets) : "&kids=".concat(manup.kids_tickets);
      }
      if (manup.entry_tickets > 0) {
        manup.ticket_booking_params += manup.ticket_booking_params == "" ? "entry=".concat(manup.entry_tickets) : "&entry=".concat(manup.entry_tickets);
      }
      location.href = "".concat(manup.ticket_booking_uri).concat(manup.ticket_booking_params);
    } else {
  ...
  manup.userMobileInput = function () {
  ...
  manup.userPasswordInput = function () {
    if (manup.userPassword.length > 0) {
      if (manup.userPassword.length < 8) {
        manup.userPasswordError = "Password is minimum 8 characters";
        return;
      } else {
        manup.userPasswordError = "";
      }
  ...
  manup.userCnfmPasswordInput = function () {
    if (manup.userCnfmPassword.length > 0) {
      if (manup.userPassword != manup.userCnfmPassword) {
        manup.userCnfmPasswordError = "password & confirm passowrd is not match";
      } else {
        manup.userCnfmPasswordError = "";
      }
    } else {
  ...
  manup.contactUsMessageInput = function () {
  ...
  manup.contact_email_input = function () {
  ...
  manup.contact_mobile_input = function () {
  ...
  manup.registerSubmit = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            if (!(manup.userName != null && manup.userMobile != null && manup.userEmail != null && manup.userPassword != null && manup.userDob != null && manup.userCnfmPassword != null)) {
              _context.next = 17;
              break;
            }
            date_of_birth = new Date(manup.userDob);
            manup.registerData = {
              user_name: manup.userName,
              user_mobile: manup.userMobile,
              user_email: manup.userEmail,
              user_password: manup.userPassword,
              user_dob: "".concat(date_of_birth.getDate(), "-").concat(date_of_birth.getMonth() + 1, "-").concat(date_of_birth.getFullYear()),
            ...
            _context.next = 17;
            return axios.post("/register", manup.registerData).then(function (res) {
  ...
  /***************************** Login Form *************************************/
  manup.loginSubmit = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 11;
            return axios.post("/login", manup.registerData).then(function (res) {
  ...
  manup.get_details = function () {
    ...
    //     }
    // });
    manup.package_ticket_number = manup.package_ticket_number.filter(function (item) {
      return item.count > 0;
    });
    $.each(manup.package_ticket_number, function (index, item) {
      for (var i = 0; i < item.count; i++) {
        item.check_in_details.push({
          name: "preson_".concat(i + 1),
    ...
    // Email Validation
    if (manup.contact_email.length == 0 || !validateEmail(manup.contact_email)) {
      manup.contact_emailError = "Enter Vaild Email Address";
      alert("Enter Vaild Email Address");
      return;
    }
    // Mobile validation
    if (manup.contact_mobile.length == 0 || manup.contact_mobile.length != 10) {
      manup.contact_mobileError = "Enter Vaild Mobile Number";
  ...
  var ticket_code = generateRandomString();
  manup.book_ticket = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var options, qrCode;
      ...
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          options = {
            ...
            width: 300,
            height: 300,
            data: "".concat(window.location.origin, "/admin/ticket/").concat(ticket_code),
            margin: 0,
            qrOptions: {
              typeNumber: "0",
              mode: "Byte",
          ...
          manup.ticket_price_details = manup.ticket_price_quantity.filter(function (item) {
          ...
          manup.ticket_details = {
            ...
            promo_code: manup.promocode != null && manup.promo_status ? manup.promo_code_details : null,
            ticket_code: ticket_code
          };
          qrCode.getRawData("png").then(/*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    formData.append("ticket_details", JSON.stringify(manup.ticket_details));
                    _context3.next = 6;
                    return axios.post("/ticket-booking", formData).then(function (res) {
                      var _res$data3 = res.data,
                        message = _res$data3.message,
                        status = _res$data3.status,
                        ticket_code = _res$data3.ticket_code;
                      if (status) {
                        location.href = "/booked_ticket_details/".concat(ticket_code);
                      } else {
                        alert(message);
                      }
  ...
  manup.ticket_init = function (data) {
  ...
  manup.checkin_btn = function (pricePackage, check_in_index) {
    manup.check_in_person = manup.ticket_person.find(function (element) {
      return element.name == pricePackage;
    });
    $.each(manup.check_in_person["check_in_details"], function (index, item) {
  ...
  manup.checked_in_submit = /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(ticket_code) {
      var data;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 3;
            return axios.post("/checked_in", data).then(function (res) {
  ...
  manup.whos_speak = [{
    ...
    more_link: "https://en.wikipedia.org/wiki/Farina_Azad#:~:text=She%20started%20her%20career%20as,which%20aired%20on%20Sun%20TV."
  }, {
    name: "VIGNESH PRABU",
    designation: "MAGICIAN",
    image: "img/team-member/vignesh_prabu.webp",
    instagram_id: "https://www.instagram.com/magician_vigneshprabhu/",
    ...
    instagram_id: "https://www.instagram.com/riya_thiyagarajan/?hl=en",
  ...
  manup.contactUsSendBtn = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ...
            if (manup.contactUsMessage == null || manup.contactUsMessage == undefined) {
              manup.contactUsMessageError = "This Fild Is Required";
            }
            if (!(manup.userName != null && manup.userMobile != null && manup.contactUsMessage != null && manup.userEmail != null)) {
              _context6.next = 14;
              break;
            }
            ...
            _context6.next = 13;
            return axios.post("/contact_us", manup.registerData).then(function (res) {
  ...
  manup.bookingInit = function (ticket_count_array) {
    manup.all_ticket_details = [];
    manup.all_ticket_details.push(ticket_count_array);
    manup.ticket_price_quantity = manup.ticket_price.map(function (item) {
      return {
        name: item.name,
        price: item.price,
        quantity: manup.all_ticket_details[0][item.name] || "0",
        // Default to 0 if not in b
        total: item.price * (parseInt(manup.all_ticket_details[0][item.name]) || 0) // Calculate total price
      };
    });
    manup.total_price = manup.ticket_price_quantity.reduce(function (sum, item) {
      return sum + item.total;
    }, 0);
    manup.total_price_tax = 18 / 100 * manup.total_price;
    manup.total_amount = (manup.total_price + manup.total_price_tax).toFixed(2);
  };
  ...
  manup.promocode_btn = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          $("#booking_continue_btn").addClass("disabled");
          _context7.next = 8;
          return axios.post("/check-promocode", {
            promo: manup.promocode
          }).then(function (res) {
            ...
            if (status) {
              ...
              manup.promo_percentage = "".concat(data.percentage, "%");
              manup.promo_percentage_value = (data.percentage / 100 * manup.total_amount).toFixed(2);
              manup.total_amount = (manup.total_amount - manup.promo_percentage_value).toFixed(2);
            } else {
              manup.promo_percentage_value = 0;
              alert(message);
            }
  ...
  manup.promocode_cancel_btn = function () {
    manup.total_amount = (Number(manup.total_amount) + Number(manup.promo_percentage_value)).toFixed(2);
  ...
  manup.forgetPassword = /*#__PURE__*/function () {
  ...
  manup.resetPassword = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          case 0:
            ...
            if (!(manup.userEmail != null && manup.userPassword != null && manup.userCnfmPassword != null && manup.userPassword == manup.userCnfmPassword)) {
              _context9.next = 9;
              break;
            }
            data = {
            ...
            _context9.next = 8;
            return axios.post("/reset-password", data).then(function (res) {
              var _res$data8 = res.data,
                message = _res$data8.message,
                status = _res$data8.status,
                data = _res$data8.data,
                alertMeaasge = _res$data8.alertMeaasge;
              if (status) {
                manup.userEmailMessage = message;
                setTimeout(function () {
                  manup.userEmailMessage = "";
